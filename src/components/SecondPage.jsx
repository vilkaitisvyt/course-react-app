...
const SecondPage = () => {
    ...
    return (
        <Grid container direction="column" style={{color: "white", background: "url(nice3.jpg) no-repeat center fixed", backgroundSize: "cover"}}>
            ...
            <Grid item container>
                ...
                <Grid item container style={{ marginBottom: 80, padding: 80, border: "1px solid white", borderRadius: "1%", background: "rgba(0, 0, 0, .6)" }} xs={12} md={8} justify="center">
            ...
            <Grid item container>
                <Grid item sm={false} md={2}/>
                <Grid item container style={{ marginBottom: 80, padding: 50, border: "1px solid white", borderRadius: "1%", background: "rgba(0, 0, 0, .6)" }} xs={12} md={8} justify="center">
                    ...
                    <Button variant="contained" color="primary" style={{ margin: "50px 0 50px 0", padding: 20 }} onClick={() => history.push("/congratulations")}>
                        Finished
                    </Button>                  
                </Grid>                             
                <Grid item sm={false} md={2}/>
